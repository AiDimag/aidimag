...
![CLI review walkthrough showing a proposal with keep/reword/drop prompt](/screenshots/dim-review.png)
...
![Dashboard review queue with click-to-approve buttons](/screenshots/dashboard-review-queue.png)
